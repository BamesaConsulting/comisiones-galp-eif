function calcularComision() {
    ...
    if (tipoDeProducto === 12) {
        resultado = (((consumo / 1000) * feeEnergia + (sumPotencias * feePotencia)) * 0.9) * 0.85;
    } else if (tipoDeProducto === 24) {
        resultado = ((((consumo / 1000) * feeEnergia + (sumPotencias * feePotencia)) * 0.9) * 2) * 0.85;
    } else if (tipoDeProducto === 36) {
        resultado = ((((consumo / 1000) * feeEnergia + (sumPotencias * feePotencia)) * 0.9) * 3) * 0.85;
    }
